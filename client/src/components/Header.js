                ...
                <AppBar position="static">
                    <Toolbar>
                        ...
                        {this.props.user.currentUser ? (
                            ...
                            : (
                                <div>
                                    <Button color="inherit" className={classes.login} onClick={() => { this.props.history.push("/register") }}>Register</Button>
                                    <Button color="inherit" className={classes.login} onClick={() => { this.props.history.push("/login") }}>Login</Button>
                                </div>
                            )
                        }
                    </Toolbar>
                    ...
                    >
                        <List className={classes.list}>
                            <ListItem button onClick = {()=>{this.props.history.push("/"); this.handleDrawerClose()}}>
                                ...
                                <ListItemText>DnD App</ListItemText>
                            </ListItem>
                            <Divider />
                            {this.props.user.currentUser ? (
                                <div>
